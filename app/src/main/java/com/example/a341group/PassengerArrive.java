...
public class PassengerArrive extends AppCompatActivity implements OnMapReadyCallback, TaskLoadedCallback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        passengerDbRef.child(documentId).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                endStr = passenger.getEndLocation();
                setMap();
            }
        ...
        emergencyBtn.setOnClickListener(v -> {
            Toast.makeText(PassengerArrive.this, "Calling 911!", Toast.LENGTH_LONG).show();
        });
    ...
    public void setMap(){
        ...
        new FetchURL(PassengerArrive.this).execute(getUrl(startLoc.getPosition(), endLoc.getPosition(), "driving"), "driving");
