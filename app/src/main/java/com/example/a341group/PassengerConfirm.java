...
public class PassengerConfirm extends AppCompatActivity implements OnMapReadyCallback, TaskLoadedCallback{
    ...
    public void setMap(){
        ...
        new FetchURL(PassengerConfirm.this).execute(getUrl(startLoc.getPosition(), endLoc.getPosition(), "driving"), "driving");
